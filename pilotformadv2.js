var Flight_Experience, Medical_Conditions, Criminal_History, Time, Become_pilot, Get_Started, Name, name, email, phone;
...
var we_tabs_next_button = '[bloc=next-question]';
    ...
    window.location.replace('https://www.av8prep.com/success');
    window.location.href('https://www.av8prep.com/success');
  }
});
