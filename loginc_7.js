var Flight_Experience, input_value, Medical_Conditions;
...
var we_tabs_next_button = '[bloc=next-question]';
    ...
    }if($('.w--tab-active').attr('data-w-tab')=='Flight_Experience') {
        updateValueInInput(input_value,"Flight_Experience");
  if (getValueFromInputData('Flight_Experience') == 'None') {
    window.location.href = 'https://av8prepprod.webflow.io/not-qualified';
  } else {
